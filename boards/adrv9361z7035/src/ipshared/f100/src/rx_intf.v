...
`timescale 1 ns / 1 ps
    ...
    /*ADDED*/
    wire [(2*IQ_DATA_WIDTH-1) : 0] ant_data_after_sel_2;
    /**/
    ...
    /*ADDED*/
    assign bw20_i1 = ant_data_after_sel_2[  (IQ_DATA_WIDTH-1) : 0];
    assign bw20_q1 = ant_data_after_sel_2[(2*IQ_DATA_WIDTH-1) : IQ_DATA_WIDTH];
    /**/
...
// ---------------------------fro antenna selection from acc domain to adc domain-------------------------------------
    ...
    adc_intf # (
        ...
        .bb_gain(slv_reg11[2:0]), // number of bit shift to left
        .data_to_acc(ant_data_after_sel_2),
        .emptyn_to_acc(bw20_iq1_valid),
        .acc_ask_data(1'b1&(~slv_reg10[1]))
    );
