...
proc create_hier_cell_openwifi_ip { parentCell nameHier } {
  ...
  # Create instance: IQ_Adder_0, and set properties
  set IQ_Adder_0 [ create_bd_cell -type ip -vlnv NTSCHI01:User:IQ_Adder:1.0 IQ_Adder_0 ]
  ...
  connect_bd_net -net IQ_Adder_0_iq_strOut [get_bd_pins IQ_Adder_0/iq_strOut] [get_bd_pins openofdm_rx_0/sample_in] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
